...
/**
 * Base class for all data models in the hospital system.
...
public abstract class Model {
     ...
     * For composite keys, return comma-separated string
     */
    public abstract String getPrimaryKeyColumn();

    /**
     * Returns the primary key value(s)
     * For composite keys, could return a Map or array
     */
    public abstract Object getPrimaryKeyValue();

    /**
     * Converts the model to a Map of column names to values
     * Used by QueryBuilder to generate INSERT and UPDATE statements
     */
